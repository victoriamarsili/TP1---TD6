...
Luego de entrenar el modelo optimizado, logramos predecir si una canción será popular (según el umbral definido por nosotros)
utilizando únicamente las características disponibles en el dataset de Spotify. Aunque el modelo alcanzó un nivel de precisión
de 0.837, los resultados no fueron tan satisfactorios como esperábamos. 

Al mejorar el modelo mediante la optimización de los hiperparámetros, logramos incrementar el área bajo la curva AUC-ROC en
aproximadamente un 10%. Esto se consiguió a través de una optimización bayesiana con 1000 iteraciones.

En cuanto a la efectividad del árbol de decisión para este problema, esperábamos un rendimiento superior. Después de numerosos
intentos de mejora, concluimos que la popularidad de una canción no parece estar fuertemente correlacionada con las variables
presentes en el dataset. Además, es posible que el enfoque basado en modelos de árboles de decisión no sea el más adecuado
