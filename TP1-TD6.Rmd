...
# If you want to get only the 'target_column' values that are 1, use:
...
confusion_matrix[1][1] <- confusion_matrix[1][1] / negative_len

confusion_matrix[1][1]

confusion_matrix[2][1] <- confusion_matrix[2][1] / positive_len

confusion_matrix[2][1]

confusion_matrix[1][2] <- confusion_matrix[1][2] / negative_len

confusion_matrix[1][2]

confusion_matrix[2][2] <- confusion_matrix[2][2] / positive_len
